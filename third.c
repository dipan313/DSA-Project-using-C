...
void loadRoutesFromFile(TrainRoute **head)
{
    ...
    if (file == NULL)
    {
        ...
        insertRoute(head, "Sealdah", "Naihati", 10, 1.10);
        insertRoute(head, "Sealdah", "Baranagar", 6, 0.50);
        insertRoute(head, "Sealdah", "Dum Dum", 4, 0.30);
        insertRoute(head, "Sealdah", "Bidhan Sarani", 3, 0.20);
        insertRoute(head, "Sealdah", "North Dumdum", 7, 0.55);
        insertRoute(head, "Sealdah", "Chandannagar", 15, 2.0);
        insertRoute(head, "Sealdah", "Kamarhati", 9, 0.75);
        insertRoute(head, "Sealdah", "Garia", 14, 1.85);
        insertRoute(head, "Sealdah", "Sodepur", 12, 1.65);
