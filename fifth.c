...
{
    char startStation[50];   char destination[50];
    int stoppages;
...
void insertRoute(TrainRoute **head, RouteStack *stack, char *startStation, char *destination, int stoppages, float duration)
{
    ...
    // Only push the route onto the stack if the stack is provided (not NULL)
    if (stack != NULL)
    {
...
void loadRoutesFromFile(TrainRoute **head, RouteStack *stack)
{
    ...
    if (file == NULL)
    {
        ...
        insertRoute(head, stack, "Sealdah", "Bongaon", 13, 1.75);
        insertRoute(head, stack, "Sealdah", "Kolkata", 5, 0.45);
        insertRoute(head, stack, "Sealdah", "Howrah", 8, 0.65);
        insertRoute(head, stack, "Sealdah", "Naihati", 10, 1.10);
        insertRoute(head, stack, "Sealdah", "Baranagar", 6, 0.50);
        insertRoute(head, stack, "Sealdah", "Dum Dum", 4, 0.30);
        insertRoute(head, stack, "Sealdah", "Bidhan Sarani", 3, 0.20);
        insertRoute(head, stack, "Sealdah", "North Dumdum", 7, 0.55);
        insertRoute(head, stack, "Sealdah", "Chandannagar", 15, 2.0);
        insertRoute(head, stack, "Sealdah", "Kamarhati", 9, 0.75);
        insertRoute(head, stack, "Sealdah", "Garia", 14, 1.85);
        insertRoute(head, stack, "Sealdah", "Sodepur", 12, 1.65);
    ...
    {
        insertRoute(head, stack, startStation, destination, stoppages, duration);
    }
...
int main()
{
    ...
    loadRoutesFromFile(&head, &routeStack);
